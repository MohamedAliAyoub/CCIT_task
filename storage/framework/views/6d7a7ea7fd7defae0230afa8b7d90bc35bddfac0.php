        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <?php echo Form::open(['url' => route('user.subscription.order-post'), 'data-parsley-validate', 'id' => 'payment-form']); ?>
                        ...
                        <div class="form-group" id="product-group">
                            <?php echo Form::label('plane', 'Select Plan:'); ?>

                            <?php echo Form::select('plane', ['price_***' => 'Game ($50)','price_***' => 'Movie ($100)'], null, [
                                'class'                       => 'form-control',
                                'required'                    => 'required',
...
<?php /**PATH C:\laragon\www\ccit_task\ccit\resources\views/dashboards/users/subscription/create.blade.php ENDPATH**/ ?>